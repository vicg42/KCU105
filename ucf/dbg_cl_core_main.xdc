...
#CL(Z)
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_clk_n[0]}]
set_property PACKAGE_PIN C24        [get_ports {pin_in_cl_clk_n[0]}]
set_property PACKAGE_PIN D24        [get_ports {pin_in_cl_clk_p[0]}]
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_clk_p[0]}]
set_property DIFF_TERM_ADV TERM_100 [get_ports {pin_in_cl_clk_p[0]}]
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_di_n[0]}]
set_property PACKAGE_PIN K8         [get_ports {pin_in_cl_di_n[0]}]
set_property PACKAGE_PIN L8         [get_ports {pin_in_cl_di_p[0]}]
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_di_p[0]}]
set_property DIFF_TERM_ADV TERM_100 [get_ports {pin_in_cl_di_p[0]}]
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_di_n[1]}]
set_property PACKAGE_PIN J11        [get_ports {pin_in_cl_di_n[1]}]
set_property PACKAGE_PIN K11        [get_ports {pin_in_cl_di_p[1]}]
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_di_p[1]}]
set_property DIFF_TERM_ADV TERM_100 [get_ports {pin_in_cl_di_p[1]}]
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_di_n[2]}]
set_property PACKAGE_PIN D10        [get_ports {pin_in_cl_di_n[2]}]
set_property PACKAGE_PIN E10        [get_ports {pin_in_cl_di_p[2]}]
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_di_p[2]}]
set_property DIFF_TERM_ADV TERM_100 [get_ports {pin_in_cl_di_p[2]}]
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_di_n[3]}]
set_property PACKAGE_PIN C9         [get_ports {pin_in_cl_di_n[3]}]
set_property PACKAGE_PIN D9         [get_ports {pin_in_cl_di_p[3]}]
set_property IOSTANDARD LVDS        [get_ports {pin_in_cl_di_p[3]}]
set_property DIFF_TERM_ADV TERM_100 [get_ports {pin_in_cl_di_p[3]}]
...
connect_debug_port dbg_hub/clk [get_nets p_out_rxclk]
