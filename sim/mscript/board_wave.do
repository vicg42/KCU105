...
add wave -noupdate /board/EP/pcie_app_uscale_i/PIO_i/pio_ep/ep_mem/rd_data
add wave -noupdate /board/EP/pcie_app_uscale_i/PIO_i/pio_ep/ep_mem/wr_addr
add wave -noupdate /board/EP/pcie_app_uscale_i/PIO_i/pio_ep/ep_mem/wr_be
add wave -noupdate /board/EP/pcie_app_uscale_i/PIO_i/pio_ep/ep_mem/wr_data
add wave -noupdate /board/EP/pcie_app_uscale_i/PIO_i/pio_ep/ep_mem/wr_en
add wave -noupdate /board/EP/pcie_app_uscale_i/PIO_i/pio_ep/ep_mem/wr_busy
add wave -noupdate /board/EP/pcie_app_uscale_i/PIO_i/pio_ep/ep_mem/payload_len
add wave -noupdate /board/EP/pcie_app_uscale_i/PIO_i/pio_ep/ep_mem/gen_transaction
add wave -noupdate /board/EP/pcie_app_uscale_i/PIO_i/pio_ep/ep_mem/gen_leg_intr
...
update
WaveRestoreZoom {0 ps} {5530442 ps}
